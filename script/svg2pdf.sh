...
# See <https://gist.github.com/s417-lama/84bf66de1096c4587e8187092fb41684>
...
chromium-browser --no-sandbox --disable-setuid-sandbox --headless --disable-gpu --print-to-pdf=$OUTPUT $tmpfile
